...
module.exports.main = function (vvClient, response) {
  ...
  var intakeValue = getFeeValue(customQueryRespData, "Intake Value"); //Keeps track of the value for the intake questionnaire forms.
  var intreatmentValue = getFeeValue(customQueryRespData, "Intreatment Value"); //Keeps track of the value of an in-treatment type questionnaire.
  var endoftreatValue = getFeeValue(
    customQueryRespData,
    "End of Treatment Value"
  ); //Keeps track of the value of an end of treatment type questionnaire.
  ...
  var groupIntreatValue = getFeeValue(
    customQueryRespData,
    "Group Intreat Value"
  );
  var groupEOTValue = getFeeValue(customQueryRespData, "Group EOT Value");
  var supervisorValue = getFeeValue(customQueryRespData, "Supervisor Value");
